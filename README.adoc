...
* https://docs.openrewrite.org/recipes[Recipe catalog] OpenRewrite recipe catalog
* https://github.com/spring-projects-experimental/spring-boot-migrator[Spring boot migrator] is a CLI tool which offers recipes to migrate/upgrade an application to Spring boot and is compatible with & uses OpenRewrite
