...
A brief overview of the approach is documented https://docs.openrewrite.org/running-recipes/running-rewrite-without-build-tool-plugins[here] on the OpenRewrite website.
