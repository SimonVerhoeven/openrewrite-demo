...
Besides the obvious framework upgrade assistance, it can also aid us with resolving critical issues like `Spring4shell` through `org.openrewrite.java.spring.cve.Spring4Shell` for example.
