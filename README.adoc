...
* fixes: such as log4shell, https://github.com/openrewrite/rewrite-spring/blob/main/src/main/resources/Spring4Shell.java[spring4shell], ...
* migrations: (log4j => slf4j, java 8 => 11 => 17, JUnit 4 => 5, ...)
* static analysis fixes: autoformatting, resolve issues by SAST tools, remove unused imports, apply a new convention using a recipe, ...
