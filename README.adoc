...
*note:* there are multiple recipes that can be used from this. For example there's also `org.openrewrite.java.spring.boot2.SpringBoot2JUnit4to5Migration` which is a superset of of the JUnit 4 to 5 & Mockito 1 to 3 recipes.
